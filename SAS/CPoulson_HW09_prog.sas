/***********************************************************************************/
/*Program Name: CPoulson_HW09_prog.sas*/
/*Program Location: C:\Users\rockc\OneDrive\Documents\A&M\2022\Spring 2022\STAT 657\Homework Assignments\9*/
/*Author: Casey Poulson*/
/*Creation Date: 23 March 2022*/
/*Last Run Date: 28 March 2022*/
...
OPTIONS MAUTOSOURCE SASAUTOS=('C:\Users\rockc\OneDrive\Documents\A&M\2022\Spring 2022\STAT 657\SAS Data\macros',sasautos);

/*(4) Creating output fileref for pdf output, and opening the file destination*/

FILENAME output 'C:\Users\rockc\OneDrive\Documents\A&M\2022\Spring 2022\STAT 657\Homework Assignments\9\CPoulson_HW09_output.pdf';
ODS PDF FILE= output;
...
/*(13) */
/*(a) 10 MISY majors made an A in Course1 in 201730.*/

/*(b) DATATYP macro got into the work library by running step 6 of this program.*/
/*My macro CPoulson_macro got into the work library by running the separate program*/
/*file CPoulson_macro. Both are visible in the output on page 7.*/

/*(c) The student who had the longest interval had a passing grade of C, and*/
/*he/she passed Course1 in Fall 2019.*/

/*(d) In my Mylib folder, I have three datasets Both_Courses, Course1_Only, and*/
/*Grades, that were created in previous assignments with member type DATA.*/
/*I have one view DFW with member type VIEW created in previous assignment.*/
/*I also have two catalogs myfmts and sasmacr with member type CATALOG.*/
/*These are a folder to store permanent custom formats, and permanent macros,*/
/*respectively.*/
